...
export default function ProductViewCard({addToCart,image,title,price,description,reviews,categary}){
    ...
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
     ...
     {description}
        ...
        <div className="flex justify-between mt-2">
          ...
          <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 focus:text-red-600  ml-4">
            <svg
              fill="currentColor"
              strokeLinecap="round"
              strokeLinejoin="round"
